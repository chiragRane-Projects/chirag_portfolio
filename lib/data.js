...
export const projects = [
  {
    ...
    description:
      "A comprehensive fintech platform designed to restructure personal finance. Built for scale, security, and absolute precision. It features real-time expense tracking, investment portfolio analysis, and automated budget generation using AI algorithms.",
    ...
    features: [
      {
        ...
        description:
          "Monitor your spending patterns with live updates and categorized transactions.",
      },
      {
        title: "AI Budget Generation",
        description:
          "Automated budget creation based on your spending habits and financial goals.",
      },
      {
        title: "Investment Portfolio Analysis",
        description:
          "Track and analyze your investment performance with detailed insights.",
      },
      {
        title: "Secure Authentication",
        description:
          "Multi-layer security with encrypted data storage and secure API endpoints.",
      },
    ],
    challenges: [
      {
        ...
        problem:
          "Ensuring all financial data updates in real-time across multiple devices without conflicts.",
        solution:
          "Implemented WebSocket connections with MongoDB change streams for instant data synchronization.",
      },
      {
        title: "Security & Compliance",
        problem:
          "Handling sensitive financial data while maintaining strict security standards.",
        solution:
          "Used JWT authentication, data encryption, and followed PCI DSS compliance guidelines.",
      },
    ],
  },
  {
    ...
    challenges: [
      {
        ...
        solution:
          "Implemented lazy loading, optimized images with Next.js Image component, and used Framer Motion's performance optimizations.",
      },
      {
        ...
        solution:
          "Used CSS autoprefixer and tested extensively across browsers, implementing fallbacks for older versions.",
      },
    ],
  },
  {
    id: "03",
    title: "Kimaya Interiors",
    tagline: "Elevating Spaces with Timeless Design",
    description:
      "A premium digital portfolio for an interior design firm specializing in residential and commercial transformations. The platform emphasizes visual storytelling, featuring high-resolution project galleries, service breakdowns, and a seamless client inquiry system to convert visitors into leads.",
    tech: ["Next.js", "Tailwind CSS", "Framer Motion"],
    images: ["/kimaya1.png", "/kimaya2.png", "/kimaya3.png"],
    link: "https://kimaya-interiors.com/",
    github: "https://github.com/chiragRane-Projects/kimaya_interiors",
    year: "2025",
    status: "Live",
    ...
    features: [
      {
        ...
        description:
          "Showcasing completed projects with high-quality imagery and smooth transition effects.",
      },
      {
        title: "Service Categorization",
        description:
          "Detailed sections for Residential, Commercial, and Modular Kitchen designs.",
      },
      {
        title: "Interactive Lead Generation",
        description:
          "A streamlined contact and inquiry system for potential clients to request quotes.",
      },
      {
        title: "Dynamic Motion UI",
        description:
          "Utilizing entrance animations to reflect the premium nature of the interior design brand.",
      },
    ],
    challenges: [
      {
        title: "Visual Fidelity vs. Performance",
        problem:
          "Maintaining high-resolution project images without compromising the site's loading speed.",
        solution:
          "Utilized Next.js Image optimization and WebP formats to ensure crisp visuals with minimal file size.",
      },
      {
        title: "Responsive Aesthetic",
        problem:
          "Ensuring the complex architectural layouts translate elegantly to smaller mobile screens.",
        solution:
          "Adopted a mobile-first grid system with Tailwind CSS to maintain the luxury feel across all devices.",
      },
    ],
  },
  {
    ...
    challenges: [
      {
        ...
        solution:
          "The only solution for this was going through different youtube tutorial videos. Due to expo making things easier for app development in javascript environment, the usage of CLI is less.",
      },
      {
    ...
    challenges: [
      {
        ...
        solution:
          "Models accuracy will increase when you add more and more of data. You need to create a python script to feed in large quantity of data, once done your ML model shall work well. I wouldnt say that it will give you 100% correct, but it'll be 80% accurate.",
      },
      {
        title: "Deployment",
        problem:
        ...
        solution:
          "You have to go through youtube videos, documentation, AI especially when you are a debutant for deploying backend services.",
      },
      {
        ...
        solution:
          "I used AmazonQ for building UI, writing functionality like context etc I did myself but for interface I will be honest I used AI. But realizing this and seeing my dependancy on AI I have taken an oath to make my hand stronger for frontend and code by myself even if it requires me to understand/learn concepts from scratch.",
      },
    ],
  },
  {
    ...
    description:
      "Creditwise is a platform where users get their credit score on basis of their expenditures and incomes.",
    ...
    features: [
      {
        ...
        description:
          "On uploading a csv file of all statements, user gets an overview of savings and a creditscore",
      },
    ],
    challenges: [
      {
        ...
        problem:
          "Everything was going well untill data extraction, but once I stepped into training models for getting accurate credit score that was a deal. But no issues, it took some time but in the end it got solved.",
      },
    ],
  },
  {
    ...
    features: [
      {
        title: "RBAC",
        description:
          "Using jwt this system consists of secured role based auth.",
      },
      {
        title: "Inventory",
        description:
          "Basic CRUD operations with add ons of stock reorder reminder.",
      },
      {
        title: "Orders",
        description:
          "Sales CRUD which helps to generate some analytics regarding business.",
      },
      {
        title: "Cash Drawer",
        description:
          "Calculated closing cash on the basis of cash expenses throughout the day.",
      },
      {
        title: "Reports",
        description:
          "Four types of reports get generated viz Sales report, Expenses report, Profit-Loss report, Stock report. Reports are generated using recharts.",
      },
    ],
  },
];
